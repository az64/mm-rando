    ...
    public class Items
    {
        ...
        public static readonly ReadOnlyCollection<string> LOCATION_NAMES
            = new ReadOnlyCollection<string>(new string[] {
                ...
                "Woodfall Key 1 Chest",
                "Snowhead Map Chest",
                "Snowhead Compass Chest",
                "Snowhead Boss Key Chest",
                "Snowhead Key 1 Chest",
                "Snowhead Key 2 Chest",
                "Snowhead Key 3 Chest",
                "Great Bay Map Chest",
                "Great Bay Compass Chest",
                "Great Bay Boss Key Chest",
                "Great Bay Key 1 Chest",
                "Stone Tower Map Chest",
                "Stone Tower Compass Chest",
                "Stone Tower Boss Key Chest",
                "Stone Tower Key 1 Chest",
                "Stone Tower Key 2 Chest",
                "Stone Tower Key 3 Chest",
                "Stone Tower Key 4 Chest",
                ...
                "Great Bay Cape Upper Ledge Chest",
                ...
                "Inverted Stone Tower Chest #1",
                "Inverted Stone Tower Chest #2",
                "Inverted Stone Tower Chest #3",
        ...
        public static readonly ReadOnlyCollection<string> HINT_REGIONS
            = new ReadOnlyCollection<string>(new string[] {
                ...
                "Stone Tower Temple",//"Ikana Great Fairy",
                "Southern Swamp",//"Kotake",
                "Romani Ranch",//"Aliens Defense",
                "Goron Village",//"Goron Race", // arguable
                "Zora Cape",//"Beaver Race #1",
                ...
                "Goron Village",//"Twin Islands Heart Piece Chest", // arguable
                "Great Bay",//"Ocean Spider House Heart Piece Chest",
                ...
                "Ikana Canyon",//"Invisible Soldier",
                ...
                "Romani Ranch",//"Gorman Bros Race", // arguable
                ...
                "Zora Cape",//"Zora Shop Shield",
                "Zora Cape",//"Zora Shop 10 Arrows",
                "Zora Cape",//"Zora Shop Red Potion",
                "",//"Bottle: Fairy",
                "",//"Bottle: Deku Princess",
                "",//"Bottle: Fish",
                "",//"Bottle: Bug",
                ...
                "Goron Village",//"Hot Spring Water Grotto", // arguable
                "Ikana Graveyard",//"Day 1 Grave Bats",
                "Ikana Canyon",//"Secret Shrine Grotto",
                "Pirates' Fortress",//"Pirates' Fortress Interior Lower Chest",
                "Pirates' Fortress",//"Pirates' Fortress Interior Upper Chest",
                "Pirates' Fortress",//"Pirates' Fortress Interior Tank Chest",
                "Pirates' Fortress",//"Pirates' Fortress Interior Guard Room Chest",
                "Pirates' Fortress",//"Pirates' Fortress Heart Piece Room Chest #1", // shallow?
                "Pirates' Fortress",//"Pirates' Fortress Heart Piece Room Chest #2", // deep?
                "Pirates' Fortress",//"Pirates' Fortress Maze Chest",
                ...
                "Great Bay",//"Great Bay Coast Grotto",
                "Zora Cape",//"Great Bay Cape Upper Ledge Chest",
                "Zora Cape",//"Great Bay Cape Lower Ledge Chest",
                "Zora Cape",//"Great Bay Cape Grotto",
                "Zora Cape",//"Great Bay Cape Underwater Chest",
                "Pirates' Fortress",//"Pirates' Fortress Exterior Log Chest",
                "Pirates' Fortress",//"Pirates' Fortress Exterior Corner Chest",
                "Pirates' Fortress",//"Pirates' Fortress Exterior Sand Chest",
                "Southern Swamp",//"Path to Swamp Grotto",
                ...
                "Bottom of the Well",//"Well Right Path Chest",
                "Bottom of the Well",//"Well Left Path Chest",
                "Mountain Village",//"Mountain Waterfall Chest",
                "Mountain Village",//"Mountain Spring Grotto",
                "Ikana Canyon",//"Path to Ikana Pillar Chest",
                "Ikana Canyon",//"Path to Ikana Grotto",
                "Stone Tower",//"Inverted Stone Tower Chest #1",
                "Stone Tower",//"Inverted Stone Tower Chest #2",
                "Stone Tower",//"Inverted Stone Tower Chest #3",
                "Mountain Village",//"Path to Snowhead Grotto", // arguable
                "Goron Village",//"Twin Islands Cave Chest", // arguable
                "Ikana Canyon",//"Secret Shrine Heart Piece Chest", // arguable
                "Ikana Canyon",//"Secret Shrine Dinolfos Chest",    // arguable
                "Ikana Canyon",//"Secret Shrine Wizzrobe Chest",    // arguable
                "Ikana Canyon",//"Secret Shrine Wart Chest",        // arguable
                "Ikana Canyon",//"Secret Shrine Garo Master Chest", // arguable
                ...
                "Southern Swamp",//"Path to Swamp Heart Piece",
                ...
                "Great Bay",//"Lab Fish Heart Piece",
                "Zora Cape",//"Great Bay Like-Like Heart Piece",
                "Pirates' Fortress",//"Pirates' Fortress Heart Piece",
                "Zora Cape",//"Zora Hall Scrub Heart Piece",
                "Mountain Village",//"Path to Snowhead Heart Piece", // arguable
                "Great Bay",//"Great Bay Coast Heart Piece",
                ...
                "Southern Swamp",//"Woodfall Map Purchase",
                "Southern Swamp",//"Snowhead Map Purchase",
                "Romani Ranch",//"Romani Ranch Map Purchase",
                "Romani Ranch",//"Great Bay Map Purchase",
                "Great Bay",//"Stone Tower Map Purchase",
                "Mountain Village",//"Goron Racetrack Grotto", // arguable
                ...
                "",//"Four Masks",
                "",//"Moon Access",
                "The Moon",//"Deku Trial Heart Piece",
                "The Moon",//"Goron Trial Heart Piece",
                "The Moon",//"Zora Trial Heart Piece",
                "The Moon",//"Link Trial Heart Piece",
                "The Moon",//"Majora Child",
        });
