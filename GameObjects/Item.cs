...
namespace MMRando.GameObjects
{
    public enum Item
    {
        ...
        [ShopInventory(ShopInventoryAttribute.Room.CuriosityShop, 0x54, 0x1440)]
        [GetItemIndex(0x7E)]
        MaskAllNight = 69,
        ...
        [ItemName("Garo Mask"), LocationName("Gorman Bros Race"), RegionName("Milk Road")]
        ...
        [ShopInventory(ShopInventoryAttribute.Room.BombShop, 0x44, 0X1520)]
        [GetItemIndex(0xC5)]
        ...
        [GossipLocationHint("a town merchant"), GossipItemHint("explosives")]
        [ShopInventory(ShopInventoryAttribute.Room.BombShop, 0x42, 0x1500)]
        [GetItemIndex(0xC6)]
        ...
        [ShopInventory(ShopInventoryAttribute.Room.GoronShop, 0x48, 0x15A0, 0x1600)]
        [GetItemIndex(0xC7)]
        ...
        [ShopInventory(ShopInventoryAttribute.Room.GoronShop, 0x44, 0x15C0, 0x1620)]
        [GetItemIndex(0xC8)]
        ...
        [ShopInventory(ShopInventoryAttribute.Room.GoronShop, 0x46, 0x15E0, 0x1640)]
        [GetItemIndex(0xC9)]
        ...
        [ShopInventory(ShopInventoryAttribute.Room.ZoraShop, 0x4A, 0x1540)]
        [GetItemIndex(0xCA)]
        ...
        [ShopInventory(ShopInventoryAttribute.Room.ZoraShop, 0x44, 0x1560)]
        [GetItemIndex(0xCB)]
        ...
        [ShopInventory(ShopInventoryAttribute.Room.ZoraShop, 0x46, 0x1580)]
        [GetItemIndex(0xCC)]
        ...
        [ItemName("Heart Piece"), LocationName("Odolwa Heart Container"), RegionName("Woodfall Temple")]
        [GossipLocationHint("a masked evil"), GossipItemHint("increased life")]
        [GetItemIndex(0x11A)]
        HeartContainerWoodfall = 245,

        [ItemName("Heart Piece"), LocationName("Goht Heart Container"), RegionName("Snowhead Temple")]
        [GossipLocationHint("a masked evil"), GossipItemHint("increased life")]
        [GetItemIndex(0x11B)]
        HeartContainerSnowhead = 246,

        [ItemName("Heart Piece"), LocationName("Gyorg Heart Container"), RegionName("Great Bay Temple")]
        [GossipLocationHint("a masked evil"), GossipItemHint("increased life")]
        [GetItemIndex(0x11C)]
        HeartContainerGreatBay = 247,

        [ItemName("Heart Piece"), LocationName("Twinmold Heart Container"), RegionName("Stone Tower Temple")]
        [GossipLocationHint("a masked evil"), GossipItemHint("increased life")]
        [GetItemIndex(0x11D)]
